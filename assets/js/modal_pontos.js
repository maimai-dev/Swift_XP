document.addEventListener('DOMContentLoaded', function () {
    ...
    const userPointsElement = document.getElementById('user-points-balance');
    ...
    function openModal(rewardCard) {
        ...
        const currentUserPoints = parseInt(userPointsElement.textContent.replace(/\./g, ''));
    ...
    confirmButton.addEventListener('click', function () {
        ...
        const newTotalPoints = currentUserPoints - rewardCost;

        
        userPointsElement.textContent = newTotalPoints.toLocaleString('pt-BR');
